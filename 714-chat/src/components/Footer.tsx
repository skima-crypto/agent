...
export default function Footer() {
  return (
    <footer className="w-full border-t border-gray-800 bg-gray-950 text-gray-400 py-6">
      <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between px-6 gap-3">
        ...
        <p className="text-sm text-center sm:text-left">
          ...
          <span className="ml-2 text-gray-500">• Powered by <span className="text-sky-400 font-medium">Base 💙</span></span>
        </p>
