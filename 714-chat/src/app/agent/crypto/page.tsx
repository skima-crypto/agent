...
export default function CryptoAgentPage({ onClose }: { onClose?: () => void }) {
  ...
  return (
    ...
    >
      ...
      >
        <button
          onClick={() => (onClose ? onClose() : router.push("/agent"))} // ✅ Safe fallback
          className="flex items-center gap-2 hover:text-blue-500 transition"
        >
          <ArrowLeft size={20} />
          <span className="font-semibold hidden sm:block">Back to Agent</span>
        </button>
